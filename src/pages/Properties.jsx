          ...
          <div className="bg-dark-800 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-gold-500/20">
            <div className="relative">
              <button
                ...
                className="absolute top-4 right-4 z-10 w-10 h-10 bg-dark-700/90 backdrop-blur-sm rounded-full flex items-center justify-center text-gray-300 hover:text-white transition-colors border border-gold-500/20"
              >
